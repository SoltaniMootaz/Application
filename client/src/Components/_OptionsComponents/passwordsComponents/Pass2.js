...
import { changeCle } from "../../../services/Options";
  ...
  const handleSubmit = (event) => {
    ...
    if (pass1 === pass2)
      if (pass1.length >= 6) {
        ...
        setErr("Votre clé doit être contenir 6 caractéres minimum");
      }
    else setErr("Vérifier votre clé");
  };
  const handlePass1Change = (e) => {
    setsPass1(e.target.value);
  };
  const handlePass2Change = (e) => {
    setsPass2(e.target.value);
  };
