  ...
  return (
    ...
    <div>
      <ThemeProvider theme={theme}>
        ...
        <Grid container >
          <Grid item xs={12}>
            <TextField id="standard-basic" color="secondary" label="Nombre de tables" onChange={(e)=>setNbTable(e.target.value)} required style={{width:'100%'}}/>
          </Grid>
        </Grid>
        <Grid container justify="center" style={{ marginTop: '10px' }}>
            <Button variant="outlined" color='secondary' style={{ textTransform: "none", width:'20em',marginTop:'2em' }} type="submit" onClick={(e) => submit(e)}>Valider</Button>
        </Grid>
        </Paper>
        </ThemeProvider>
    </div>
